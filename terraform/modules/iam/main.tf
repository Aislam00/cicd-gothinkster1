...
resource "aws_iam_role_policy" "jenkins_basic" {
  name = "${var.project_name}-${var.environment}-jenkins-basic"
...
resource "aws_iam_role_policy" "app_basic" {
  name = "${var.project_name}-${var.environment}-app-basic"
